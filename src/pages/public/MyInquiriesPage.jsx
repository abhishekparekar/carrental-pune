...
export default function MyInquiriesPage() {
  ...
  const handleShareWhatsApp = (item) => {
    ...
    window.open(`https://wa.me/919270762176?text=${encoded}`, '_blank');
  };
              ...
              {loading ? (
                ...
                <div className="glass-card empty-state" style={{ background: '#FFFFFF', padding: '36px 20px', textAlign: 'center', borderRadius: 16, border: '1px solid #E2E8F0' }}>
                  <div className="empty-state-icon" style={{ margin: '0 auto 12px' }}>
                    <FiFileText size={42} color="#C8000A" />
                  </div>
                        ...
                        <div>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                            ...
                            <button
                              ...
                              style={{ border: 'none', background: 'none', cursor: 'pointer', color: '#C8000A', padding: 0 }}
                              title="Copy Ref ID"
                            >
                              <FiCopy size={12} />
                            </button>
                      ...
                      <div style={{
                        ...
                        <div>
                          ...
                          <strong style={{ color: '#0F172A', display: 'flex', alignItems: 'center', gap: 4, marginTop: 2 }}>
                            <FiMapPin size={12} color="#C8000A" /> {item.city || 'Pune'}
                          </strong>
                        </div>
                        ...
                        <div>
                          ...
                          <strong style={{ color: '#0F172A', textTransform: 'capitalize', display: 'flex', alignItems: 'center', gap: 4, marginTop: 2 }}>
                            <BsCarFront size={12} color="#C8000A" /> {item.pickupType || 'Doorstep Delivery'}
                          </strong>
                        </div>
                        ...
                        <div>
                          ...
                          <strong style={{ color: '#0F172A', display: 'flex', alignItems: 'center', gap: 4, marginTop: 2 }}>
                            <FiCalendar size={12} color="#C8000A" /> {formatTimestamp(item.createdAt)}
                          </strong>
                        </div>
                        ...
                        {item.estimatedPrice && (
                          <div>
                            ...
                            <strong style={{ color: '#C8000A', fontSize: 14, fontWeight: 900 }}>
