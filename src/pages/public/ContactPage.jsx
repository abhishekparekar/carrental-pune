                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <div className="form-group" style={{ margin: 0 }}>
                    ...
                    <textarea
                      ...
                      placeholder="Enter your rental inquiry, preferred car, dates, or doorstep delivery details..."
                      value={form.message}
                  ...
                  <button
                    ...
                    style={{ background: '#C8000A', borderColor: '#C8000A', fontSize: 14, fontWeight: 800, padding: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}
                  >
