...
const CLIENT_PRESETS = [
  {
    ...
    description: 'Spacious 7-seater Maruti Ertiga VXI Petrol+CNG ideal for economical group travel and family tours.',
  },
  {
    ...
    description: 'Premium Maruti Baleno Delta hatchback with smooth city driving experience and high efficiency.',
  },
  {
    ...
    isPopular: true,
    imagesText: 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?auto=format&fit=crop&w=800&q=80',
    description: 'Feature-packed Baleno Zeta CNG variant for fuel-efficient highway and city trips.',
  },
  {
    name: 'Thar 4×2 Diesel',
    brand: 'Mahindra',
    category: 'suv',
    pricePerDay: 5000,
    extraKmRate: 7,
    ...
    description: 'Iconic Mahindra Thar 4x2 Diesel with supreme road presence and tough stance.',
  },
  {
    ...
    description: 'Agile Maruti Swift VXI (O) petrol hatchback, perfect for easy city navigation.',
  },
  {
    name: 'Tata Nexon CNG',
    brand: 'Tata',
    ...
    description: '5-Star safety rated Tata Nexon CNG SUV with high ground clearance and eco performance.',
  },
  {
    name: 'WagonR VXI CNG',
    brand: 'Maruti',
    ...
    description: 'Tall-boy design Maruti WagonR VXI CNG, easy entry/exit and ultra affordable rental rate.',
  },
  {
    ...
    description: 'Stylish Maruti Fronx Sigma crossover SUV with modern styling and comfortable ride.',
  },
  {
    ...
    isPopular: true,
    imagesText: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=800&q=80',
    description: 'Hyundai Venue S+ equipped with electric sunroof, touchscreen infotainment and SUV stance.',
  },
];
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            ...
            <button onClick={handleOpenAdd} className="btn btn-primary btn-sm" style={{ gap: 6, background: '#C8000A', borderColor: '#C8000A', fontSize: 12.5, padding: '8px 14px' }}>
              <FiPlus /> Add Vehicle
            </button>
          </div>
        </div>
        ...
        <div className="grid-4" style={{ gap: 10 }}>
          <div style={{ background: '#FFFFFF', padding: '10px 14px', borderRadius: 10, border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(200,0,10,0.08)', color: '#C8000A', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <BsCarFront size={18} />
            </div>
          </div>
          ...
          <div style={{ background: '#FFFFFF', padding: '10px 14px', borderRadius: 10, border: '1px solid #E2E8F0', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              ...
              <strong style={{ fontSize: 18, color: '#C8000A', display: 'block', lineHeight: 1.1 }}>{cars.filter(c => c.isPopular !== false).length}</strong>
            </div>
            <div style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(200,0,10,0.08)', color: '#C8000A', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <FiZap size={18} />
            </div>
        ...
        {/* Quick Fill Preset Templates Container */}
        <div style={{
          background: '#F8FAFC',
          ...
          <div style={{
            ...
            <FiZap style={{ color: '#FF5722', fontSize: 14 }} /> QUICK FILL PRESET TEMPLATES:
          </div>
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
            {CLIENT_PRESETS.map((preset, idx) => (
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = '#C8000A';
                  e.currentTarget.style.color = '#C8000A';
              ...
              >
                {preset.name} ({formatCurrency(preset.pricePerDay)})
              </button>
            ))}
          </div>
        </div>
        ...
        <div style={{
          padding: '10px 14px',
          borderRadius: 10,
          background: 'linear-gradient(135deg, rgba(200, 0, 10, 0.05) 0%, #FFFFFF 100%)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <FiZap style={{ color: '#C8000A', flexShrink: 0 }} />
            <span>
          ...
          {loading ? (
            ...
            <div className="empty-state">
              <div className="empty-state-icon">
                <BsCarFront size={48} color="#C8000A" />
              </div>
              ...
              <button onClick={handleOpenAdd} className="btn btn-primary btn-sm" style={{ background: '#C8000A', borderColor: '#C8000A' }}>
                + Add New Vehicle
              </button>
            </div>
          ) : (
                  ...
                  {filteredCars.map((c) => {
                    ...
                    return (
                      <tr key={c.id}>
                        ...
                        <td>
                          <strong style={{ color: '#C8000A', fontSize: 13.5 }}>{formatCurrency(c.pricePerDay)}/d</strong>
                        </td>
                        <td>
                          <span style={{ fontSize: 11.5, fontWeight: 800, color: '#C8000A', background: 'rgba(200,0,10,0.06)', padding: '2px 6px', borderRadius: 99 }}>
                            ₹{extraKm}/km
                          </span>
                        </td>
                        <td>
                        ...
                        <td>
                          <button
                            ...
                            style={{
                              ...
                              fontSize: 10.5,
                              fontWeight: 800,
                              background: c.isPopular !== false ? 'rgba(200, 0, 10, 0.12)' : '#F1F5F9',
                              color: c.isPopular !== false ? '#C8000A' : '#64748B',
                              transition: 'all 0.15s ease',
                              display: 'inline-flex',
                              alignItems: 'center',
                              gap: 4,
                          ...
                          >
                            {c.isPopular !== false ? <><FiZap size={11} color="#C8000A" /> Popular</> : 'Standard'}
                          </button>
                        </td>
                        <td>
                          <button
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div style={{ position: 'relative', borderRadius: 12, overflow: 'hidden', height: 200, background: '#0F172A' }}>
              ...
              <div style={{ position: 'absolute', top: 10, left: 10, display: 'flex', gap: 6 }}>
                ...
                {viewingCar.isPopular !== false && (
                  <span className="badge badge-warning" style={{ background: '#C8000A', color: '#FFFFFF', fontWeight: 800 }}>
                    ⭐ Most Popular
                  </span>
                )}
              </div>
            ...
            <div style={{ background: '#F8FAFC', padding: 12, borderRadius: 10, border: '1px solid #E2E8F0', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 10 }}>
              <div>
                ...
                <strong style={{ fontSize: 16, color: '#C8000A', display: 'block' }}>{formatCurrency(viewingCar.pricePerDay)}/day</strong>
              </div>
              <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
              ...
              <div style={{ padding: 10, borderRadius: 8, background: '#FFFFFF', border: '1px solid #E2E8F0' }}>
                ...
                <strong style={{ fontSize: 13, color: viewingCar.isActive !== false ? '#16A34A' : '#EF4444' }}>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 4 }}>
              <button
                ...
                style={{ background: '#C8000A', borderColor: '#C8000A', fontWeight: 800, padding: '7px 16px' }}
              >
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {!editingCar && (
            <div style={{
              ...
              <span style={{ fontSize: 11.5, color: '#475569', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.6px', display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10 }}>
                <FiZap style={{ color: '#FF5722', fontSize: 14 }} /> QUICK FILL PRESET TEMPLATES:
              </span>
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {CLIENT_PRESETS.map((preset, idx) => (
          ...
          <div style={{
            ...
            <FiInfo size={14} style={{ color: '#C8000A', flexShrink: 0 }} />
            <span>
          ...
          <div className="form-group" style={{ background: '#F8FAFC', padding: 14, borderRadius: 12, border: '1px solid #E2E8F0' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8, flexWrap: 'wrap', gap: 6 }}>
              <label className="form-label" style={{ margin: 0, display: 'flex', alignItems: 'center', gap: 6 }}>
                <FiImage style={{ color: '#C8000A' }} /> Vehicle Photos (Upload from Device or Paste Image Links)
              </label>
          ...
          <button
            ...
            style={{ background: '#C8000A', borderColor: '#C8000A', marginTop: 4 }}
          >
