    ...
    <AdminLayout>
      <div style={{ padding: '24px 20px', maxWidth: 980, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
          <div>
            <span style={{ fontSize: 11, fontWeight: 800, color: '#C8000A', textTransform: 'uppercase', letterSpacing: 0.8 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: 16, fontWeight: 800, color: '#111318', margin: '0 0 16px', display: 'flex', alignItems: 'center', gap: 8 }}>
              <FiMessageSquare color="#C8000A" /> Add & Manage Customer Reviews
            </h3>
            ...
            <form onSubmit={handleAddReview} style={{
              ...
              <strong style={{ fontSize: 13, color: '#C8000A', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
